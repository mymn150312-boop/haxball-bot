...
setTimeout(function() {
  room.sendAnnouncement("⚽ Futsal VN Scrim 2 - Việt Nam 🇻🇳", -1, 0x00FF00);
}, 500);
setTimeout(function() {
...
room.onPlayerChat = function(player, message) {
  ...
  if (cmd === "!help") {
    ...
    setTimeout(function() { room.sendAnnouncement("ℹ️ !info - Room info", player.id, 0xFFD700); }, 100);
    setTimeout(function() { room.sendAnnouncement("👮 !admin - Get admin", player.id, 0xFFD700); }, 200);
    setTimeout(function() { room.sendAnnouncement("👑 !super pronhat - Super admin", player.id, 0xFFD700); }, 300);
    return false;
  }
  if (cmd === "!info") {
...
console.log("✅ Futsal VN Scrim 2 Room Loaded!");
};
